...
func fish_data() -> Ruleset.CardData:
	var bad_fish := get_config("fish_card", "Bad Fish") as String
	var more_fish := get_config("fish_card", "More Fish") as String
	var good_fish := get_config("fish_card", "Good Fish") as String
